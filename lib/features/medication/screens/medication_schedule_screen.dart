...
class _MedicationScheduleScreenState extends State<MedicationScheduleScreen> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(icon: const Icon(Icons.today), onPressed: () => controller.goToToday(), tooltip: 'Today'),
        ],
      ),
      body: Obx(() {
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const Text('Prescription not found', style: TextStyle(color: Colors.grey)),
        ...
        return Column(
          children: [
            ...
            // Medications List
            Expanded(child: _buildMedicationsList(prescription)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.medical_services, color: TColors.primary, size: 30),
                ),
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(prescription.doctorName, style: Get.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                      Text(prescription.clinicName, style: Get.textTheme.bodyMedium?.copyWith(color: Colors.grey[600])),
                    ],
                  ),
                ),
                Chip(
                  ...
                  labelStyle: Get.textTheme.labelSmall?.copyWith(color: Colors.white),
                ),
              ],
            ),
            const SizedBox(height: TSizes.md),
            Text(
              'Medication Schedule',
              style: Get.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold, color: TColors.primary),
            ),
  ...
  Widget _buildDateSelector() {
    return Padding(
      ...
      child: Row(
        children: [
          IconButton(icon: const Icon(Icons.chevron_left), onPressed: controller.previousDay, tooltip: 'Previous Day'),
          Expanded(
            child: Obx(
              () => GestureDetector(
                onTap: () => _selectDate(),
                  ...
                  child: Column(
                    children: [
                      Text(
                        ...
                        style: Get.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold, color: Colors.blue),
                      ),
                      Text(controller.selectedDayWeekday, style: Get.textTheme.bodySmall?.copyWith(color: Colors.blue.shade600)),
                    ],
                  ),
                ),
              ),
          ...
          IconButton(icon: const Icon(Icons.chevron_right), onPressed: controller.nextDay, tooltip: 'Next Day'),
          IconButton(icon: const Icon(Icons.calendar_today), onPressed: () => _selectDate(), tooltip: 'Select Date'),
        ],
      ),
    );
  }
      ...
      return Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.medical_services, size: 64, color: Colors.grey),
            const SizedBox(height: TSizes.md),
            const Text('No medications scheduled for this date', style: TextStyle(color: Colors.grey)),
            const SizedBox(height: TSizes.xs),
            Text('Try selecting another date', style: TextStyle(color: Colors.grey[600], fontSize: 12)),
          ],
        ),
      );
    }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.medical_services, color: _getMedicationColor(medication), size: 24),
                ),
                const SizedBox(width: TSizes.md),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(medication.name, style: Get.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                      if (medication.genericName.isNotEmpty)
                        Text(medication.genericName, style: Get.textTheme.bodySmall?.copyWith(color: Colors.grey)),
                    ],
                  ),
                ),
                // Status Indicator
            ...
            Row(
              children: [
                _buildDetailChip(icon: Icons.medication, text: medication.dosage, color: Colors.blue),
                const SizedBox(width: TSizes.sm),
                _buildDetailChip(icon: Icons.access_time, text: medication.frequency, color: Colors.purple),
                const SizedBox(width: TSizes.sm),
                _buildDetailChip(icon: Icons.calendar_today, text: medication.duration, color: Colors.green),
              ],
            ),
            ...
            // Timings
            Text('Timings:', style: Get.textTheme.labelMedium?.copyWith(fontWeight: FontWeight.bold)),
            const SizedBox(height: TSizes.xs),
            Wrap(
              spacing: TSizes.xs,
              children: medication.timings.map((time) {
                ...
                return Chip(
                  label: Text(time, style: Get.textTheme.labelSmall?.copyWith(color: isTimePassed ? Colors.white : Colors.black)),
                  backgroundColor: isTimePassed
                      ? Colors.grey
                      : isTimeNow
                      ? Colors.orange
                      : Colors.blue.shade100,
                  avatar: isTimeNow ? const Icon(Icons.access_time, size: 14, color: Colors.white) : null,
                );
              }).toList(),
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(TSizes.cardRadiusSm),
                border: Border.all(color: _getTimeStatusColor(timeStatus).withOpacity(0.3)),
              ),
              child: Row(
                children: [
                  Icon(_getTimeStatusIcon(timeStatus), color: _getTimeStatusColor(timeStatus), size: 16),
                  const SizedBox(width: TSizes.sm),
                  Expanded(
                    child: Text(
                      timeStatus,
                      style: Get.textTheme.bodySmall?.copyWith(color: _getTimeStatusColor(timeStatus), fontWeight: FontWeight.w500),
                    ),
                  ),
                ],
              ),
            ...
            if (medication.instructions?.isNotEmpty == true) ...[
              const SizedBox(height: TSizes.md),
              Text('Instructions:', style: Get.textTheme.labelMedium?.copyWith(fontWeight: FontWeight.bold)),
              Text(medication.instructions!, style: Get.textTheme.bodyMedium),
            ],
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('Take with food', style: Get.textTheme.labelSmall?.copyWith(color: Colors.green)),
                  ],
                ),
              ),
            ],
            ...
            if (medication.sideEffects?.isNotEmpty == true) ...[
              ...
              Text(
                ...
                style: Get.textTheme.labelSmall?.copyWith(color: Colors.red, fontWeight: FontWeight.bold),
              ),
              Wrap(
                spacing: TSizes.xs,
                children: medication.sideEffects!
                    .map(
                      (effect) => Chip(
                        label: Text(effect, style: Get.textTheme.labelSmall?.copyWith(color: Colors.red)),
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    icon: Icon(isTaken ? Icons.check_circle : Icons.check, size: 16),
                    label: Text(isTaken ? 'Already Taken' : 'Mark as Taken'),
                    style: ElevatedButton.styleFrom(backgroundColor: isTaken ? Colors.grey : Colors.green),
                  ),
                ),
              ],
            ),
  ...
  Widget _buildDetailChip({required IconData icon, required String text, required Color color}) {
    return Chip(
      ...
      labelStyle: Get.textTheme.labelSmall?.copyWith(color: color, fontWeight: FontWeight.w500),
    );
  }
  ...
  Widget _buildStatistics() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildStatItem(icon: Icons.medical_services, value: controller.totalMedications, label: 'Total', color: Colors.blue),
          _buildStatItem(icon: Icons.check_circle, value: controller.takenMedications, label: 'Taken', color: Colors.green),
          _buildStatItem(icon: Icons.warning, value: controller.missedMedications, label: 'Missed', color: Colors.red),
          _buildStatItem(icon: Icons.access_time, value: controller.pendingMedications, label: 'Pending', color: Colors.orange),
        ],
      ),
    );
  }

  Widget _buildStatItem({required IconData icon, required int value, required String label, required Color color}) {
    return Column(
      children: [
        Container(
          width: 40,
    ...
    Get.bottomSheet(
      Container(
        ...
        decoration: const BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.only(topLeft: Radius.circular(TSizes.cardRadiusLg), topRight: Radius.circular(TSizes.cardRadiusLg)),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            const SizedBox(height: TSizes.md),
            Text(medication.name, style: Get.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
            if (medication.genericName.isNotEmpty) ...[
              const SizedBox(height: TSizes.xs),
              Text('(${medication.genericName})', style: Get.textTheme.bodyMedium?.copyWith(color: Colors.grey)),
            ],
            const SizedBox(height: TSizes.md),
            ...
            if (medication.instructions?.isNotEmpty == true) _buildDetailRow('Instructions', medication.instructions!),
            if (medication.notes?.isNotEmpty == true) _buildDetailRow('Notes', medication.notes!),
            const SizedBox(height: TSizes.md),
            Text('Timings:', style: Get.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
            const SizedBox(height: TSizes.xs),
            Wrap(
              spacing: TSizes.xs,
              children: medication.timings.map((time) => Chip(label: Text(time))).toList(),
            ),
          ],
        ),
      ),
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            ...
            child: Text(
              '$label:',
              style: Get.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold, color: Colors.grey[700]),
            ),
          ),
          const SizedBox(width: TSizes.sm),
